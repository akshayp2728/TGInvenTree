...
function createNewModal(options={}) {
    ...
    if (!options.hideSubmitButton) {
        buttons += `<button type='button' class='btn btn-${submitClass}' id='modal-form-submit'>Enviar</button>`;
    }
    ...
    modalSetSubmitText(modal_name, options.submitText || 'Enviar');
...
function openModal(options) {
    ...
    var submit_text = options.submit_text || 'Enviar';
    var close_text = options.close_text || 'Cerrar';
