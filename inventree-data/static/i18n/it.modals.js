...
function createNewModal(options={}) {
    ...
    if (!options.hideSubmitButton) {
        buttons += `<button type='button' class='btn btn-${submitClass}' id='modal-form-submit'>Invia</button>`;
    }
    ...
    modalSetSubmitText(modal_name, options.submitText || 'Invia');
...
function openModal(options) {
    ...
    var submit_text = options.submit_text || 'Invia';
    var close_text = options.close_text || 'Chiudi';
