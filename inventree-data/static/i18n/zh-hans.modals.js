...
function createNewModal(options={}) {
    ...
    if (!options.hideSubmitButton) {
        buttons += `<button type='button' class='btn btn-${submitClass}' id='modal-form-submit'>提交</button>`;
    }
    ...
    modalSetSubmitText(modal_name, options.submitText || '提交');
...
function openModal(options) {
    ...
    var submit_text = options.submit_text || '提交';
    var close_text = options.close_text || '关闭';
