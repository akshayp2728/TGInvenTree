...
function createNewModal(options={}) {
    ...
    if (!options.hideSubmitButton) {
        buttons += `<button type='button' class='btn btn-${submitClass}' id='modal-form-submit'>Küldés</button>`;
    }
    ...
    modalSetSubmitText(modal_name, options.submitText || 'Küldés');
...
function openModal(options) {
    ...
    var submit_text = options.submit_text || 'Küldés';
    var close_text = options.close_text || 'Bezárás';
