...
function createNewModal(options={}) {
    ...
    if (!options.hideSubmitButton) {
        buttons += `<button type='button' class='btn btn-${submitClass}' id='modal-form-submit'>제출</button>`;
    }
    ...
    modalSetSubmitText(modal_name, options.submitText || '제출');
...
function openModal(options) {
    ...
    var submit_text = options.submit_text || '제출';
    var close_text = options.close_text || '닫기';
