...
function createNewModal(options={}) {
    ...
    if (!options.hideSubmitButton) {
        buttons += `<button type='button' class='btn btn-${submitClass}' id='modal-form-submit'>Envoyer</button>`;
    }
    ...
    modalSetSubmitText(modal_name, options.submitText || 'Envoyer');
...
function openModal(options) {
    ...
    var submit_text = options.submit_text || 'Envoyer';
    var close_text = options.close_text || 'Fermer';
