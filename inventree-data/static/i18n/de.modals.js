...
function createNewModal(options={}) {
    ...
    if (!options.hideSubmitButton) {
        buttons += `<button type='button' class='btn btn-${submitClass}' id='modal-form-submit'>Absenden</button>`;
    }
    ...
    modalSetSubmitText(modal_name, options.submitText || 'Absenden');
...
function openModal(options) {
    ...
    var submit_text = options.submit_text || 'Absenden';
    var close_text = options.close_text || 'Schließen';
