...
function createNewModal(options={}) {
    ...
    if (!options.hideSubmitButton) {
        buttons += `<button type='button' class='btn btn-${submitClass}' id='modal-form-submit'>Kaydet</button>`;
    }
    ...
    modalSetSubmitText(modal_name, options.submitText || 'Kaydet');
...
function openModal(options) {
    ...
    var submit_text = options.submit_text || 'Kaydet';
    var close_text = options.close_text || 'Kapat';
