...
function createNewModal(options={}) {
    ...
    if (!options.hideSubmitButton) {
        buttons += `<button type='button' class='btn btn-${submitClass}' id='modal-form-submit'>Indienen</button>`;
    }
    ...
    modalSetSubmitText(modal_name, options.submitText || 'Indienen');
...
function openModal(options) {
    ...
    var submit_text = options.submit_text || 'Indienen';
    var close_text = options.close_text || 'Sluiten';
