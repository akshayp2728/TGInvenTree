            ...
            },
            {
                ...
                formatter: function(value, row, index, field) {
                    ...
                    if (options.allow_edit || options.allow_delete) {
                        ...
                        if (options.allow_edit) {
                            html += makeCopyButton('button-duplicate', pk, 'Duplicate line');
                            html += makeEditButton('button-edit', pk, 'Edit line');
                        }

                        if (options.allow_delete) {
                            html += makeDeleteButton('button-delete', pk, 'Delete line', );
                        }
                    }
