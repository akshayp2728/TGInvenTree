...
function createNewModal(options={}) {
    ...
    if (!options.hideSubmitButton) {
        buttons += `<button type='button' class='btn btn-${submitClass}' id='modal-form-submit'>Wyślij</button>`;
    }
    ...
    modalSetSubmitText(modal_name, options.submitText || 'Wyślij');
...
function openModal(options) {
    ...
    var submit_text = options.submit_text || 'Wyślij';
    var close_text = options.close_text || 'Zamknij';
