...
function createNewModal(options={}) {
    ...
    if (!options.hideSubmitButton) {
        buttons += `<button type='button' class='btn btn-${submitClass}' id='modal-form-submit'>Lähetä</button>`;
    }
    ...
    modalSetSubmitText(modal_name, options.submitText || 'Lähetä');
...
function openModal(options) {
    ...
    var submit_text = options.submit_text || 'Lähetä';
    var close_text = options.close_text || 'Sulje';
